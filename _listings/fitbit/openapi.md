...
paths:
  ...
  /user/-/glucose/date/{date}.json:
    get:
      ...
      x-api-path-slug: userglucosedatedatejson-get
      responses:
        200:
          description: OK
      tags:
  ...
  /user/-/bp/date/{date}.json:
    get:
      ...
      x-api-path-slug: userbpdatedatejson-get
      responses:
        200:
          description: OK
      tags:
  ...
  /user/-/heart/date/{date}.json:
    get:
      ...
      x-api-path-slug: userheartdatedatejson-get
      responses:
        200:
          description: OK
      tags:
  ...
  /user/{user-id}/sleep/date/{date}.json:
    get:
      ...
      x-api-path-slug: useruseridsleepdatedatejson-get
      responses:
        200:
          description: OK
      tags:
  ...
  /user/{user-id}/foods/log/date/{date}.json:
    get:
      ...
      x-api-path-slug: useruseridfoodslogdatedatejson-get
      responses:
        200:
          description: OK
      tags:
  ...
  /user/-/body/log/fat/date/{date}.json:
    get:
      ...
      x-api-path-slug: userbodylogfatdatedatejson-get
      responses:
        200:
          description: OK
      tags:
  ...
  /user/-/body/log/weight/date/{date}.json:
    get:
      ...
      x-api-path-slug: userbodylogweightdatedatejson-get
      responses:
        200:
          description: OK
      tags:
  ...
  /user/{user-id}/body/date/{date}.json:
    get:
      ...
      x-api-path-slug: useruseridbodydatedatejson-get
      responses:
        200:
          description: OK
      tags:
  ...
  /user/-/profile.json:
    post:
      ...
      x-api-path-slug: userprofilejson-post
      responses:
        200:
          description: OK
      tags:
  ...
  /user/{user-id}/profile.json:
    get:
      ...
      x-api-path-slug: useruseridprofilejson-get
      responses:
        200:
          description: OK
      tags:
